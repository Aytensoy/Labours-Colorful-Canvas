...
canvas.willReadFrequently = true; // Bu satırı ekleyin
...
function handleDownloadClick() {
  ...
  function setupEventListeners() {
    ...
    function getCanvasCoordinates(e) {
      ...
      const rect = canvas.getBoundingClientRect(); // Her olayda rect'i yeniden hesaplayın
    ...
    canvas.addEventListener('mousemove', draw); // draw(x,y) fonksiyonunu kullanacak
    canvas.addEventListener('mouseup', stopDrawing);
    canvas.addEventListener('mouseout', stopDrawing);

    // Dokunma olay dinleyicileri
